...
def generate_heroes(arquivo1,arquivo2):
    ...
    json=json.json()
    fieldnames=['nome','atributo_primario','tipo_ataque']
    ...
    with open(arquivo1, mode='w') as csv_file:
        ...
        for hero in json:
            ...
            writer.writerow({'nome': json[hero]['localized_name'], 'atributo_primario': json[hero]['primary_attr'],'tipo_ataque':json[hero]['attack_type']})
